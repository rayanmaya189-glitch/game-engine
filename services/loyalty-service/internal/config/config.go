...
type LoyaltyConfig struct {
	PointsPerBet        float64            `yaml:"points_per_bet"`
	PointsMultiplierVIP map[string]float64 `yaml:"points_multiplier_vip"`
	ExchangeRate        float64            `yaml:"exchange_rate"` // points to currency
