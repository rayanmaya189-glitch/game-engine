...
/**
 * Protobuf type {@code gameengine.user.v1.Address}
 */
public final class Address extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:gameengine.user.v1.Address)
    AddressOrBuilder {
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.gameengine.user.v1.UserServiceOuterClass.internal_static_gameengine_user_v1_Address_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.gameengine.user.v1.UserServiceOuterClass.internal_static_gameengine_user_v1_Address_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.gameengine.user.v1.Address.class, com.gameengine.user.v1.Address.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.gameengine.user.v1.Address)) {
      return super.equals(obj);
    }
    com.gameengine.user.v1.Address other = (com.gameengine.user.v1.Address) obj;
  ...
  public static com.gameengine.user.v1.Address parseFrom(
  ...
  public static com.gameengine.user.v1.Address parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.gameengine.user.v1.Address parseFrom(
  ...
  public static com.gameengine.user.v1.Address parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.gameengine.user.v1.Address parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static com.gameengine.user.v1.Address parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.gameengine.user.v1.Address prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:gameengine.user.v1.Address)
      com.gameengine.user.v1.AddressOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.gameengine.user.v1.UserServiceOuterClass.internal_static_gameengine_user_v1_Address_descriptor;
    }
    ...
    // Construct using com.gameengine.user.v1.Address.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.gameengine.user.v1.Address getDefaultInstanceForType() {
      return com.gameengine.user.v1.Address.getDefaultInstance();
    }

    @java.lang.Override
    public com.gameengine.user.v1.Address build() {
      com.gameengine.user.v1.Address result = buildPartial();
    ...
    @java.lang.Override
    public com.gameengine.user.v1.Address buildPartial() {
      com.gameengine.user.v1.Address result = new com.gameengine.user.v1.Address(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(com.gameengine.user.v1.Address result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.gameengine.user.v1.Address) {
        return mergeFrom((com.gameengine.user.v1.Address)other);
      } else {
    ...
    public Builder mergeFrom(com.gameengine.user.v1.Address other) {
      if (other == com.gameengine.user.v1.Address.getDefaultInstance()) return this;
    ...
    // @@protoc_insertion_point(builder_scope:gameengine.user.v1.Address)
  }

  // @@protoc_insertion_point(class_scope:gameengine.user.v1.Address)
  private static final com.gameengine.user.v1.Address DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.gameengine.user.v1.Address();
  }

  public static com.gameengine.user.v1.Address getDefaultInstance() {
